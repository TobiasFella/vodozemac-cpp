...
mod ffi {
    ...
    extern "Rust" {
        ...
        fn account_from_olm_pickle(pickle: &str, pickle_key: &[u8]) -> Result<Box<Account>>;
        ...
        fn session_from_olm_pickle(pickle: &str, pickle_key: &[u8]) -> Result<Box<Session>>;
    ...
    extern "Rust" {
        ...
        fn group_session_from_olm_pickle(pickle: &str, pickle_key: &[u8]) -> Result<Box<GroupSession>>;
        ...
        fn inbound_group_session_from_olm_pickle(pickle: &str, pickle_key: &[u8]) -> Result<Box<InboundGroupSession>>;
    }
